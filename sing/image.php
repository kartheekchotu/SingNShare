    ...
    if($file_type == 'jpg' || $file_type == 'jpeg'||$file_type == 'png')
	 {
	   ...
	   //name=$_POST['name']; 
		...
		$nameid=$_SESSION['id']; 
		mysql_query("INSERT INTO images VALUES (NULL,'$nameid','$pic',current_timestamp,'$target')") ; 
	 ...
	 else
	 {
		...
		//  $ab=time_elapsed_string($all_audio['time'],2);	
			echo '<div class="list-group"><a  class="list-group-item active">'.$_SESSION['username']. ' has uploaded this image on '.$all_audio['time'].'</a>';
            ...
            <img  class="img-thumbnail"  alt="<?php echo $all_audio['path'];?> "  src="<?php echo $all_audio['path'];  ?>" type="image/*">
